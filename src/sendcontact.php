...
define( "RECIPIENT_NAME", "Beardy Studios" ); //UPDATE THIS TO YOUR NAME
define( "RECIPIENT_EMAIL", "hello@beardystudios.com" ); //UPDATE THIS TO YOUR EMAIL ID
define( "EMAIL_SUBJECT", "Hello!" ); //UPDATE THIS TO YOUR SUBJECT
